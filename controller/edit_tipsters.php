...
if (isset($_SESSION['username'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        header('Location:' . SITE_URL . '/controller/edit_tipsters.php');
    ...
    $editTipsters = get_all_edit_tipsters($connect);



    require '../Edits/tipsters.edit.php';
} else {
