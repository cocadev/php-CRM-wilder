    ...
    <div class="container mypunter-padding-h">
        ...
        <div class="row pt-28">
            <div class="col-md-7">
                <div id="colorlib-logo">
                    <a href="<?php echo SITE_URL; ?>/controller/index.php">
                        <img src='<?php echo SITE_URL.'/images/'.$editHome[0]['logo'] ?>' title="MyPunter" class="logo-punter nopadding img-responsive" /> </a>
                </div>
            </div>
            ...
            <div class="col-md-2 pt-17 responsive-center">
                ...
                <br />
                <a href="https://www.facebook.com/mypunter/" title="MyPunter Facebook" target="_blank">
                    <span class="fa fa-facebook"></span>
                </a>
                <a href="https://twitter.com/mypunter" title="MyPunter Instagram" target="_blank">
                    <span class="fa fa-twitter"></span>
                </a>
                <a href="https://instagram.com/my_punter/" title="MyPunter Instagram" target="_blank">
                ...
                <a class="text-white underline font-size-13" href="mailto:support@mypunter.com?subject=Thanks&body=Best Regards">support@mypunter.com</a>
                <br />
            </div>
        </div>
    </div>
