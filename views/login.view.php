...
<h4 class="title mt-3" style="color: #000">Log in!</h4>

<div style="background: #ffffff; padding: 5px 25px; border-radius: 8px; max-width: 300px; margin-left: auto; margin-right: auto;">
...
<button type="submit" class="btn btn-default" onclick="login.submit()" style="width: 100%;background-color: #e82027; border-radius: 5px; color: #fff">Log In</button>
