...
/////////////////////////////////////////////////////////////////////USERS//////////////////////////////////////////////////////////////////
function number_same_username($connect, $username){
    $total_numbers = $connect->prepare("SELECT * FROM managers WHERE username = '$username'");
...
function get_username_per_id($connect, $id){
    $sentence = $connect->query("SELECT username FROM managers WHERE id = $id");
    $sentence = $sentence->fetchAll();
    return ($sentence) ? $sentence : false;
}

/////////////////////////////////////////////////////////////////////Edit Tipsters //////////////////////////////////////////////////////////////////
function get_all_edit_tipsters($connect)
{
    $sentence = $connect->prepare("SELECT * FROM edit_tipsters WHERE id = 1");
    $sentence->execute();
    return $sentence->fetchAll();
}

/////////////////////////////////////////////////////////////////////Edit Sponsors //////////////////////////////////////////////////////////////////
function get_all_edit_sponsors($connect)
{
    $sentence = $connect->prepare("SELECT * FROM edit_sponsors WHERE id = 1");
    $sentence->execute();
    return $sentence->fetchAll();
}

/////////////////////////////////////////////////////////////////////Edit Home //////////////////////////////////////////////////////////////////
function get_all_edit_home($connect)
{
    $sentence = $connect->prepare("SELECT * FROM edit_home WHERE id = 1");
    $sentence->execute();
    return $sentence->fetchAll();
}

/////////////////////////////////////////////////////////////////////Edit Membership Levels //////////////////////////////////////////////////////////////////
function get_all_edit_membership_levels($connect)
{
    $sentence = $connect->prepare("SELECT * FROM edit_membership_levels WHERE id = 1");
    $sentence->execute();
    return $sentence->fetchAll();
}

/////////////////////////////////////////////////////////////////////Edit Results //////////////////////////////////////////////////////////////////
function get_all_edit_results($connect)
{
    $sentence = $connect->prepare("SELECT * FROM edit_results WHERE id = 1");
    $sentence->execute();
    return $sentence->fetchAll();
}
...
function get_all_tickers($connect)
{
    $sentence = $connect->prepare("SELECT * FROM tickers");
    $sentence->execute();
    return $sentence->fetchAll();
}

function get_page_users($connect, $pn, $searchKey, $count)
{
    $start_from = ($pn-1) * $count;
    $sentence = $connect->prepare("SELECT * FROM managers WHERE username LIKE '%$searchKey%' order by id desc  LIMIT $start_from, $count");
    $sentence->execute();
    return $sentence->fetchAll();
}
...
{
    $total_users = $connect->prepare('SELECT * FROM managers ');
    $total_users->execute(array());
    $total_users->fetchAll();
    $total = $total_users->rowCount();
    return $total;
}

function number_users_by_administrator($connect)
{
    $total_users = $connect->prepare('SELECT * FROM managers WHERE role = "Administrator" ');
    $total_users->execute(array());
    $total_users->fetchAll();
    $total = $total_users->rowCount();
    return $total;
...
function number_users_by_contributor($connect)
{
    $total_users = $connect->prepare('SELECT * FROM managers WHERE role = "Contributor" ');
    $total_users->execute(array());
    $total_users->fetchAll();
    $total = $total_users->rowCount();
    return $total;
...
function number_users_by_subscriber($connect)
{
    $total_users = $connect->prepare('SELECT * FROM managers WHERE role = "Subscriber" ');
    $total_users->execute(array());
    $total_users->fetchAll();
    $total = $total_users->rowCount();
    return $total;
...
function number_page_users($connect, $searchKey)
{
    $total_users = $connect->prepare("SELECT * FROM managers WHERE username LIKE '%$searchKey%'");
    $total_users->execute(array());
    $total_users->fetchAll();
    $total = $total_users->rowCount();
    return $total;
    ...
    $sentence = $connect->query("SELECT * FROM managers WHERE id = $id_user LIMIT 1");
    $sentence = $sentence->fetchAll();
    return ($sentence) ? $sentence : false;
}
...
function get_all_posts($connect)
{
    ...
    $sentence = $connect->prepare("SELECT * FROM posts order by post_id desc ");
    $sentence->execute();
    return $sentence->fetchAll();
}

function get_menu($connect)
{
...
function get_all_posts_filtered_by_datte($connect)
{

    $sentence = $connect->prepare("SELECT * FROM posts");
    $sentence->execute();
    return $sentence->fetchAll();
}
...
function get_post_per_id($connect, $id_post){
    $sentence = $connect->query("SELECT * FROM posts WHERE post_id = $id_post LIMIT 1");
    $sentence = $sentence->fetchAll();
    return ($sentence) ? $sentence : false;
}

function get_post_per_date($connect, $dates){
    $sentence = $connect->query("SELECT * FROM posts WHERE post_date = '$dates'");
    $sentence = $sentence->fetchAll();
    return ($sentence) ? $sentence : false;
}
